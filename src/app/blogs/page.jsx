      ...
      <div className="flex justify-between flex-col lg:md:flex-row">
          ...
          <div className="flex mt-5">
            ...
            <div class="relative">
              <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                <svg
                  class={`${styles.my_svg} w-4 h-4 text-gray-500 dark:text-gray-400`}
                  aria-hidden="true"
              ...
              <input
                type="search"
                id="default-search"
                class="block w-full p-4 ps-60 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              />
              <button
                type="submit"
                class=" bg_orange  text-white  absolute end-0 bottom-0.5 bg-blue-700 hovr:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-4 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Search
              </button>
            </div>
                ...
                <div>
                  ...
                  <div className=" flex  font-light space-x-48">
                    ...
                    <span className="text-xs mt-1">
                      {" "}
                      <span className="ms-1"></span>Jan 11.24
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="cards grid grid-cols-1 md:lg:grid-cols-2  ms-10 mb-10">
          ...
          <Card className={styles.card_custom_style}>
            ...
            <CardFooter>
              <p>
                AUSTIN, Texas, Jan. 11, 2024 — Ambiq@, a recognized technology
                leader in ultra-low power semiconductors for IoT endpoints.
          ...
          <Card className={styles.card_custom_style}>
            <CardHeader>
              <span className="text-sm">Jan 11.24</span>
              <CardTitle>
                The rising cost of healthcare is it too late to bring cost....
              </CardTitle>
              <CardDescription>
                {" "}
                <Image
          ...
          <Card className={styles.card_custom_style}>
            <CardHeader>
              <span className="text-sm">Jan 11.24</span>
              <CardTitle>
                Empowerinommunities through Health Education...
              </CardTitle>
              <CardDescription>
                {" "}
                <Image
        ...
        <nav>
          <ul class="flex gap-3 items-center -space-x-px h-8 text-sm">
            <li>
              <a
                href="#"
                class=" bg_orange flex items-center justify-center px-3 h-8 leading-tight text-white bg-white border border-gray-300 hover:bg-gray-100 hover:bg_orange dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                1
              </a>
            </li>
            <li>
              <a
                href="#"
                class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:bg_orange dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                2
              </a>
            </li>
            <li>
              <a
                href="#"
                class="z-10 flex items-center justify-center px-3 h-8 leading-tight borderbg-white border border-gray-300 hover:bg_orange dark:bg-gray-700 dark:text-white"
              >
                3
              </a>
            </li>
            <li>
              <a
                href="#"
                class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg_orange hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                4
              </a>
            </li>
            ...
            <li>
              <a
                href="#"
                class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-e-lg hover:bg_orange hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
