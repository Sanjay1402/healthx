...
const page = () => {
  return (
    <>
      <div className="container">
        ...
        <div className="ms-auto flex flex-col justify-end w-7/12">
          <div className="text-5xl mb-4 font-bold">
            <span className="green">Transforming Primary</span>{" "}
            <span className="orange">Healthcare</span>
          </div>
          <div className="text-4xl font-light mb-4">
            Seamless Access to Expert Care
          </div>
          <div className=" font-light text-xl">
            Healthx, powered by TruDoc, is a global healthcare management
            company in Pakistan. We provide high-quality primary healthcare
            services using innovative technology. Our offerings include
            convenient online consultations with expert doctors and wellness
            advisors.
          </div>
        </div>
        ...
        <div className="flex justify-between mt-10 mb-10 ">
          <Card className={styles.card_custom_style}>
            ...
            <CardFooter>
              <p>
                Accessible and affordable, Healthx ensures your health and
                wellness needs are met efficiently from anywhere. Choose Healthx
                for quality primary healthcare services tailored to your
                convenience and comfort
              </p>
            </CardFooter>
          </Card>
          <Image src="/phone-b.png" alt="" height="526" width="783" />
        </div>
      ...
      <div
        className={`${styles.dark} ${styles.custom_container} flex gap-5 mb-5`}
      >
        <div className="me-2">
          <div className="text-white text-4xl">Healthx</div>
        ...
        <div className="grid grid-cols-2 gap-5">
          <Card className={styles.dark_card}>
            ...
            <CardContent>
              <p>
                To transform healthcare delivery for a positive impact on
                people's lives
              </p>
            </CardContent>
          </Card>
          <Card className={styles.dark_card}>
            ...
            <CardContent>
              <p>
                Implementing fair and impartial care, uniting individuals and
                payers on a single platform
              </p>
            </CardContent>
          </Card>
          <Card className={styles.dark_card}>
            ...
            <CardContent>
              <p>
                Bringing accessible and affordable health and wellness within
                reach with just one call.
              </p>
            </CardContent>
          </Card>
          <Card className={styles.dark_card}>
            ...
            <CardContent>
              <p>
                Innovative technology and compassionate care, empowering
                individuals
              </p>
            </CardContent>
          </Card>
