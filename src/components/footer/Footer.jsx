    ...
    <div className={`${styles['footer-main-container']} -slate-500`}>
        <div className={`-black ${styles['footer-inner-container']}`}>
            ...
            <div className={`${styles.div2} -blue-100`}>
                ...
                <div className={`${styles['div2-4']}text-sm flex ms-12 justify-center`}>
                    About us <br/>
                    FAQs    <br/>
                    New's and Media <br/>
                    Contact us <br/>
                ...
                Corporate Health Solutions<br/><br/>
                Health Incurrence<br/><br/>
            ...
            {/* <br /> */}
            {/* <span></span> */}
            <div className={`${styles.div3} -red-400`}>
                I am in Div-3
            </div>
            {/* <span ></span> */}
            {/* <br /> */}
            <div className={`${styles.div4} -orange-400`}>
                I am in Div-4
            </div>
        </div>
    </div>
